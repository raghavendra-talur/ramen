...
func (in *AsyncSpec) DeepCopyInto(out *AsyncSpec) {
	*out = *in
	if in.EastClusterSet != nil {
		in, out := &in.EastClusterSet, &out.EastClusterSet
		*out = make([]EastCluster, len(*in))
		copy(*out, *in)
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AsyncSpec.
func (in *AsyncSpec) DeepCopy() *AsyncSpec {
	if in == nil {
		return nil
	}
	out := new(AsyncSpec)
...
func (in *DRPolicySpec) DeepCopyInto(out *DRPolicySpec) {
	*out = *in
	in.AsyncDRPolicySpec.DeepCopyInto(&out.AsyncDRPolicySpec)
	in.SyncDRPolicySpec.DeepCopyInto(&out.SyncDRPolicySpec)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EastCluster) DeepCopyInto(out *EastCluster) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EastCluster.
func (in *EastCluster) DeepCopy() *EastCluster {
	if in == nil {
		return nil
	}
	out := new(EastCluster)
