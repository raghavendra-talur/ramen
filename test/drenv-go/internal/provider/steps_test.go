...
// It keeps a map of profile name → Status and records Start/Delete call counts,
// making it safe for concurrent use so parallel ensure.Group tests can share it.
...
// Stop transitions the profile to StatusStopped.
